...
export const UserTable: React.FC = () => {
  ...
  const onChangeParams = (v: any) => {
    setQueryParams(v);
  }

  const tableChage = (pagination: any, filters: any, sorter: any, extra: any) => {
  ...
  return (<>
    <UserSearch onChange={onChangeParams} onInsert={openInsertPw}></UserSearch>
    <Table columns={columns} dataSource={data} onChange={tableChage} pagination={{
